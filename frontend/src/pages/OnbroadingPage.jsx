...
import { competeOnboarding } from "../api/dataService";
...
const OnbroadingPage = () => {
  ...
  const { mutate: mutateOnboarding, isPending } = useMutation({
    mutationFn: competeOnboarding,
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["authUser"] });
      toast.success("Profile onbroaded successfully");
    },
    onError: (error) => {
        ...
        <div className="card-body p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col items-center justify-center space-y-4">
              {/* IMAGE PREVIEW */}
              <div className="size-32 rounded-full bg-base-300 overflow-hidden cursor-pointer">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <MapPin className="absolute top-1/2 transform -translate-y-1/2 left-3 w-5 h-5 text-base-content opacity-70 z-10" />
                <input
                  type="text"
                  name="location"
