...
import { getOutgoingFriendRequests, getRecommendedUsers, getUserFriends, sendFriendRequest } from "../api/dataService";
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    // Kiểm tra nếu dữ liệu ở trong thuộc tính .data
    const requests = outgoingFriendRequests?.outgoingRequests;
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto space-y-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 w-full">
          ...
          <Link to="/notifications" className="btn btn-outline btn-sm rounded-2xl hover:bg-white/20">
