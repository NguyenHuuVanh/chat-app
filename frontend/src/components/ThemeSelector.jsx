...
const ThemeSelector = () => {
  ...
  return (
    <div className="dropdown dropdown-end">
      {/* DROPDOWN TRIGGER */}
      <button tabIndex={0} className="btn btn-ghost btn-circle hover:bg-white/20">
        ...
        <div className="space-y-1">
          {THEMES.map((themeOption) => (
            <button
              ...
              className={`
            w-full px-4 py-3 rounded-xl flex items-center gap-3 transition-colors duration-200 hover:bg-base-content/10 
